...
<body>
	...
	<main class="container">
		<div class="row">
			<div class="col">
				...
				<h1>Agregar imagen del producto</h1>
				...
				%>
					...
					<form id="uploadProductPhotoForm" class="row g-3 needs-validation" method="POST" 
					action="<%=request.getContextPath()%>/UploadProductPhoto"
					...
					<div class="col-md-4">
						...
						<input name="titulo" placeholder="ingrese el título" type="text"
							class="form-control" id="validationCustom02" value="<%=p.getTitulo()%>" disabled="disabled">
						<div class="valid-feedback">Looks good!</div>
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<div class="input-group">
							<input name="image" type="file" class="form-control"
								...
								aria-label="Upload" accept="image/png, image/gif, image/jpeg">
						</div>
					</div>
					<div class="col-12">
						<button class="btn btn-primary" type="submit">Cargar imagen
							producto</button>
	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    const uploadProductPhotoForm = document.getElementById('uploadProductPhotoForm');
	    const btnCancel = document.getElementById('btnCancel');

	    //uploadProductPhotoForm.addEventListener("submit", (e) => { uploadProductPhotoForm_submit(e) });
	    btnCancel.addEventListener("click", btnCancel_click);
	});

	const uploadProductPhotoForm_submit  = (e) => {
	    // ToDo
	}
