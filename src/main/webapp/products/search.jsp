	...
	<main class="container">
		<div class="row">
			<div class="colo">
				...
				<h1>Resultados de la búsqueda de <strong><%=request.getAttribute("searchKey") %></strong></h1>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<a href="<%=request.getContextPath()%>/Product?product_id=<%=p.getId()%>" ><i class="bi bi-zoom-in"></i></a>
							</td>
						</tr>
