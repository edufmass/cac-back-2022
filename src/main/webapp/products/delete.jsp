...
<body>
	...
	<main class="container">
		<div class="row">
			<div class="col">
				...
				%>
				<form id="deleteProductForm" class="row g-3 needs-validation" method="POST" 
					action="<%=request.getContextPath()%>/DeleteProduct">
					...
					<div class="col-md-4">
						...
						<input name="titulo" placeholder="ingrese el título" type="text"
							class="form-control" id="validationCustom02" value="<%=p.getTitulo()%>"
							 disabled="disabled" >
						<div class="valid-feedback">Looks good!</div>
					</div>
					<div class="col-md-4">
						...
						<input name="precio" placeholder="ingrese el precio" type="number"
							class="form-control" id="validationCustom03" disabled="disabled"
							step=".01" value="<%=p.getPrecio()%>">
						<div class="valid-feedback">Looks good!</div>
					</div>
					<div class="col-md-4">
						<label for="validationCustom04" class="form-label">Fecha
							de alta</label>
						<input name="fecha_alta" type="date" class="form-control" disabled="disabled"
							id="validationCustom04" value="<%=p.getFechaAlta()%>">
						<div class="valid-feedback">Looks good!</div>
					</div>
					<div class="col-md-4">
						...
						<input disabled="disabled"
							...
							class="form-control" id="validationCustom05" value="<%=p.getAutor()%>">
						<div class="valid-feedback">Looks good!</div>
					</div>
					<div class="col-md-4">
						<label for="validationCustom06" class="form-label">Imagen</label>
						<div class="input-group">
							<input name="image" type="file" class="form-control" disabled="disabled"
	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    deleteProductForm.addEventListener("submit", (e) => { deleteProductForm_submit(e) });
	    btnCancel.addEventListener("click", btnCancel_click);
	});

	const deleteProductForm_submit  = (e) => {
	    // ToDo
	}
